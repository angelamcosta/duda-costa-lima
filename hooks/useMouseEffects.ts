...
export function useMouseEffects() {
  useEffect(() => {
    function onMove(e: MouseEvent) {
      ...
      let bestMag: { el: HTMLElement; cx: number; cy: number; d: number } | null = null
      ...
      if (bestMag) {
        const mag = bestMag as { el: HTMLElement; cx: number; cy: number; d: number }
      ...
      const servicesContainer = document.querySelector<HTMLElement>(".services")
